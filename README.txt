...
********************************************
********************************************
The player should be able to simply run the game in a command line. 
There is no GUI at the moment but one will be added at a later point
in time.

Most of the implemented functions and menus work correctly but there 
are still input errors mostly to do with the input buffer overflowing.
There are no graphics (even ASCII) as of yet but that should be 
implemented soon.
